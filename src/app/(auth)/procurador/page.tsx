...
export default async function ProcuradorDashboard() {
  ...
  return (
    <div className="animate-fade-in space-y-8">
      ...
      <div>
        ...
        <p className="page-subtitle">Painel de consulta do procurador</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="stat-card stat-card-green">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1">Processos</p>
      ...
      <div className="flex flex-wrap gap-3">
        <Link href="/procurador/pautas" className="btn btn-primary">
          <svg className="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M4 6h16M4 10h16M4 14h16M4 18h16" />
          </svg>
          Ver Pautas
        </Link>
        <Link href="/procurador/busca" className="btn btn-secondary">
          <svg className="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        {pautas.length === 0 ? (
          <div className="empty-state">
            ...
            <p className="empty-state-text">
              Nenhuma pauta disponível para consulta.
            </p>
          </div>
        ) : (
