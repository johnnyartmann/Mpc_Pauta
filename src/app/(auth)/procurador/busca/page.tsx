...
export default function ProcuradorBuscaPage() {
  ...
  const handleSearch = async (formData: FormData) => {
    ...
    try {
      ...
      const withProcuradorLinks = data.map((r: SearchResult) => ({
        ...r,
        link: r.link.replace("/registrador/", "/procurador/"),
      }));
      setResults(withProcuradorLinks);
    } catch {
      setResults([]);
    }
    setLoading(false);
